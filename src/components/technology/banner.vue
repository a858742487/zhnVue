<template>
  ...
  <div class="banner">
    <div class="block">
      <el-carousel trigger="click"  :style="{background: 'url('+bottomBg+')'}">
          ...
          <el-row :gutter="0">
            ...
            <el-col :span="16">
              <div class="grid-content bg-purple-light bor">
                <el-input v-model="input" placeholder="请输入您要查找的官方公告"></el-input>
              </div>
            </el-col>
            <el-col :span="8">
  ...
  export default {
    ...
    data() {
      return {
        ...
        input: '',
        tableData: '',
        bottomBg : require('@/assets/images/center.jpg')
        // bannersearchbtn : ''
      }
    },
    created() {
